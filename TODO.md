...
- [ ] **Create post button** — Quick-create CTA at the top of the sidebar nav, always accessible regardless of current view
...
- [ ] **Click-to-create on calendar** — Clicking a date directly on the calendar grid opens a create post flow for that date (no planner required for single posts)
